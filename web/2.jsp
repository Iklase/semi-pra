...
<div class="container">
    <div class="btn-link2">
        <input type="button" class="btn" value="로그인" style="width: 80px" onclick="location.href='2.jsp'">
        <input type="button" class="btn" value="회원가입" style="width: 100px" onclick="location.href='3.jsp'">
    ...
    <form action="">
        <div class="form-group">
            <label for="">ID</label>
            <input type="text" class="form-control" style="width: 500px; height: 42px" placeholder="아이디를 입력하세요." required>
        </div>
        <div class="form-group">
            <label for="">PASSWORD</label>
            <input type="password" class="form-control" style="width: 500px; height: 42px" placeholder="●●●●●●●●●●●●" required>
        </div>
